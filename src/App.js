...
function BlogPost() {
  const { id } = useParams();
  const posts = [
    { id: 1, title: "The Clockwork Orchard: How AI and Machine Learning Turn Data into Decisions", 
      content: [
    ...
    { id: 2, title: "Learning React", 
      content: "React is awesome and powerful!" },
    
    
    { id: 3, title: "Why I Love Tailwind CSS", 
      content: "It makes styling so much faster." },
  ];
